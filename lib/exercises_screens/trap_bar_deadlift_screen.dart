...
class TrapDeadliftScreen extends StatefulWidget {
  ...
  TrapDeadliftScreen({required this.exerciseId});

  @override
  _TrapDeadliftScreenState createState() => _TrapDeadliftScreenState();
}

class _TrapDeadliftScreenState extends State<TrapDeadliftScreen> {
            ...
            children: [
              ...
              Container(
                ...
                child: Container(
                  ...
                  child: Image.asset(
                    '/exercise_gifs/trap_deadlift.gif',
                    fit: BoxFit.cover,
                  ),
                ),
              ),
