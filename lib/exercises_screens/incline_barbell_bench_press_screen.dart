...
class InclineBenchScreen extends StatefulWidget {
  ...
  InclineBenchScreen({required this.exerciseId});

  @override
  _InclineBenchScreenState createState() => _InclineBenchScreenState();
}
...
class _InclineBenchScreenState extends State<InclineBenchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Incline barbell bench press'),
            ...
            children: [
              ...
              Container(
                ...
                child: Container(
                  ...
                  child: Image.asset(
                    '/exercise_gifs/incline_bench.gif',
                    fit: BoxFit.cover,
                  ),
                ),
              ),
