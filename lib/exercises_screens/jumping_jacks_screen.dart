...
class JacksScreen extends StatefulWidget {
  ...
  JacksScreen({required this.exerciseId});

  @override
  _JacksScreenState createState() => _JacksScreenState();
}

class _JacksScreenState extends State<JacksScreen> {
            ...
            children: [
              Column(
                children: [
                  ExerciseDetailsWidget(
                    ...
                    repetitions: exerciseDetails['repetitions'] ?? '18-24',
              ...
              Container(
                ...
                child: Container(
                  ...
                  child: Image.asset(
                    '/exercise_gifs/jumping_jacks.gif',
                    fit: BoxFit.cover,
                  ),
                ),
              ),
